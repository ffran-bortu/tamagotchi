...
export class CommandScreenController {
    ...
    initialize() {
        ...
        // Hide the custom cursor overlay since native cursor works better
        if (this.cursorBlock && this.cursorBlock.parentElement) {
            this.cursorBlock.parentElement.style.display = 'none';
        }
    ...
    // Cursor positioning removed - using native textarea cursor instead
